...
sys.path.insert(1,'../pytorch-fid/src/')
from pytorch_fid import fid_score,inception
from torch.utils.data import Dataset
from fid_score1 import calculate_fid_given_paths_act
...
def main():
    ...
    evaluationPaths.append(os.path.join('Virtual or Generated IHC path'))

    feature_length = 2048
    fid_value = fid_score.calculate_fid_given_paths(evaluationPaths,10,device,feature_length,4)
    print("FID Metric", fid_value)
    x_features, y_features = calculate_fid_given_paths_act(evaluationPaths,10,device,2048,4)
